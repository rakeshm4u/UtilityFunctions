...
public class FilloExample {
    ...
    @Test(dataProvider = "getDataUsingFillo")
    ...
    @Test(description = "This is a create sheet and data example")
    ...
    @Test(description = "This is a Delete sheet and data example")
    ...
    @Test(description = "This is a Insert data example")
    ...
    @Test(description = "This is a Update data example")
    ...
    @Test(description = "This is a Select data example")
    ...
    public Object[][] getDataUsingFillo() {
        ...
        try {
            ...
            recordset = connection.executeQuery("SELECT * FROM DataSheet"); //Datasheet is the sheet name
            int numberOfRows = recordset.getCount();
            int i = 0;
            object = new Object[numberOfRows][];
            while (recordset.next()) {
                object[i][0] = recordset.getField("Username");
                i++;
            }
